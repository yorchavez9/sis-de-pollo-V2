            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li><a href="tarifas-envio"><i class="fas fa-tags"></i> Tarifas de Envío</a></li>
                    </ul>
                </li>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="tipoDocumento"><i class="fas fa-id-card"></i> Tipos de Documento</a></li>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li><a href="configuracion-ticket"><i class="fas fa-ticket-alt"></i> Comprobantes</a></li>
